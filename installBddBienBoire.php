...
$surLeWeb = false; // A mettre sur false quand on est en local
...
if (!$surLeWeb) {
  ...
  $mysqli=mysqli_connect('db5005953828.hosting-data.io', 'dbu1391417', 'Wa$Sr89K!', 'dbs4989374', 3306) or die("Erreur de connexion");
}
